...
const HowTo = () => {
    return ( 
        <div className="HowTo">
            ...
            <p>STEP 1: Click on “My Goals”.  Here you will select from a list of habits, amassed from other people’s suggestions on how to improve your wellbeing.</p>
            
            <p>You may add a custom habit to your list if it is not included in the list of suggestions.</p>
            
            <p>STEP 2: Go to “Daily Check-In” after you have completed your habits for the day. Follow this step every day. You can set up a daily reminder notification if you wish.</p>
            ...
            <p>STEP 3: "View Progress" Disclaimer: I am not a psychologist or a statistician. I hope to add some additional data analysis parameters as well as create a correlation score between habits and check-in scores to aid in user experience. 
